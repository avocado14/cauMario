...
마리오를 점프시켜 적들을 피해 목표거리인 70m에 도달하는 게임입니다. spacebar키로 마리오를 점프시킬 수 있으며 2단점프까지 가능합니다. 정지해 있는 적부터 움직이는 적까지 다양한 적들이 나오며 마리오가 적과 닿는 순간 게임이 종료됩니다. 목표거리에 도달하면 게임이 클리어됩니다.
...
# 스테이지 4
게임을 플레이하기 위해서는 코인이 30개 필요하고 먼저 스테이지 2를 클리어해야 합니다.
...
# 스테이지 5
게임을 플레이하기 위해서는 코인이 150개 필요하고 먼저 스테이지 4를 UNLOCK해야 합니다.
